...
func ListenRedis(ctx context.Context, cfg config.RedisNotifyConfig, logger *slog.Logger, onChange func(context.Context, string) error) func() error {
	if !cfg.Enabled || onChange == nil {
